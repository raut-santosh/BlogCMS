...
// Checking checkbox 
// Code to get values from checkboxes
    if(isset($_POST['checkBoxArray'])){

        foreach($_POST['checkBoxArray'] as $postValueId){
        // this will save option values like published, draft, delete.
...
<table class="table table-bordered table-hover">
    ...
    <div id="bulkOptionsContainer" style="padding:0; margin-bottom:10px" class="col-xs-4">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($select_posts)) {
            ...
            <!-- This is to Get the id of perticular post by array  -->
            <!-- Arraay is empty right now but when we submit that it will send value of input field to that array -->
